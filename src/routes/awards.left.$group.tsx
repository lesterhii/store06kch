...
import { LEFT_AWARDS, LEFT_GROUPS, type Product } from "@/lib/products";
import { ProductCard } from "@/components/ProductCard";

export const Route = createFileRoute("/awards/left/$group")({
  head: ({ params }) => ({ meta: [{ title: `Left Arm — ${params.group}` }] }),
  loader: ({ params }) => {
    const data = LEFT_AWARDS[params.group];
