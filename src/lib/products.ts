...
export const UNIFORM_GENERAL: Product[] = [
  { id: "u-fullset", name: "Senior Full Set Uniform", price: 150, image: uniformImg, warning: "Leather Boots are not included", category: "general" },
  { id: "u-capbadge", name: "Cap Badge", price: 5, image: uniformImg, category: "general" },
  { id: "u-armlet-l", name: 'Badge Armlet 5" x 4" (Left Arm)', price: 5, image: uniformImg, category: "general" },
  { id: "u-armlet-r", name: 'Badge Armlet 6" x 4.8" (Right Arm)', price: 6, image: uniformImg, category: "general" },
  { id: "u-tie", name: "Sky Blue Tie", price: 10, image: uniformImg, category: "general" },
  { id: "u-haversack", name: "Haversack", image: uniformImg, variants: ["Normal", "Extra Long"], sizePriceMap: [{label:"Normal",price:11.4},{label:"Extra Long",price:12.6}], category: "general" },
  { id: "u-haversack-loops", name: "Haversack Metal Loops & Slide", price: 10.8, image: uniformImg, category: "general" },
  { id: "u-haversack-btn", name: "Haversack Metal Button", price: 5.4, image: uniformImg, category: "general" },
  { id: "u-belt", name: "BB Leather Belt", price: 40, image: uniformImg, sizes: ["32","36","40","44","48"], category: "general" },
  { id: "u-sock", name: "Navy Blue Sock", price: 8.5, image: uniformImg, category: "general" },
  { id: "u-fscap", name: "Field Service Cap", price: 12.5, image: uniformImg, sizes: ["XS-54CM","S-56CM","M-58CM","L-60CM","XL-62CM"], category: "general" },
  { id: "u-mufti", name: "Senior Mufti", price: 25, image: uniformImg, sizes: ["XS-34","S-36","M-38","L-40","XL-42","XXL-42","3XL-44"], category: "general" },
  ...
  { id: "u-tshirt", name: "Senior BB T-Shirt", price: 30, image: uniformImg, sizes: ["S","M","L","XL","XXL","3XL"], category: "general" },
];

export const UNIFORM_ACCESSORIES: Product[] = [
  { id: "a-chev-lcpl", name: "Cheveron L/Cpl", price: 11, image: accessoriesImg, category: "accessories" },
  { id: "a-chev-cpl", name: "Cheveron Cpl", price: 11.5, image: accessoriesImg, category: "accessories" },
  { id: "a-chev-sgt", name: "Cheveron Sgt", price: 12, image: accessoriesImg, category: "accessories" },
  { id: "a-chev-ssgt", name: "Cheveron S/Sgt", price: 12.5, image: accessoriesImg, category: "accessories" },
  { id: "a-fsr-lcpl", name: "Field Service Rank L/Cpl", price: 5, image: accessoriesImg, category: "accessories" },
  { id: "a-fsr-cpl", name: "Field Service Rank Cpl", price: 5.5, image: accessoriesImg, category: "accessories" },
  { id: "a-fsr-sgt", name: "Field Service Rank Sgt", price: 6, image: accessoriesImg, category: "accessories" },
  { id: "a-fsr-ssgt", name: "Field Service Rank S/Sgt", price: 6.5, image: accessoriesImg, category: "accessories" },
  { id: "a-lanyard", name: "NCO Lanyard", price: 11, image: accessoriesImg, category: "accessories" },
  { id: "a-red-sash", name: "Red Sash", price: 60, image: accessoriesImg, category: "accessories" },
  { id: "a-blue-sash", name: "Blue Sash", price: 60, image: accessoriesImg, category: "accessories" },
];

const rightAward = (id: string, name: string, price: number, group: string, allowAdvanced = true): Product => ({
  id, name, price, image: rightAwardImg, category: `right-${group}`,
...
const leftAward = (id: string, name: string, price: number, group: string): Product => ({
  id, name, price, image: leftAwardImg, category: `left-${group}`,
});
