...
export const RIGHT_AWARDS: Record<string, { title: string; items: Product[] }> = {
  compulsory: { title: "Compulsory", items: [
    ...
    rightAward("ra-christed","Christian Education",8,"compulsory", "https://i.imgur.com/sfK3vRM.jpeg"),
    rightAward("ra-drill","Drill",9,"compulsory", "https://i.imgur.com/vs0buQr.png"),
    rightAward("ra-recruit","Recruitment",4,"compulsory", "https://i.imgur.com/hSD7xGz.png"),
  ]},
